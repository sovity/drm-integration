...
@Testcontainers
public interface DSC_5_1_2 {
    String CONTAINER_IMAGE_DSC = "ghcr.io/international-data-spaces-association/dataspace-connector:5.1.2";
    ...
    GenericContainer<?> dscContainer = new GenericContainer<>(CONTAINER_IMAGE_DSC)
            ...
            .withLogConsumer(new Slf4jLogConsumer(LoggerFactory.getLogger(DSC_5_1_2.class)).withPrefix("DSC"))
            .withEnv(
